HTML Link Parser Package
========================

I created this package as part of a "gophersize" - exercises to learn Golang. Below is the original instruction, as can be found at https://github.com/gophercises/link .

I am using the test library ginkgo - you can get it by performing `go get -d ./...` inside the repository. Then change directory into the tests folder and run `ginkgo`.
